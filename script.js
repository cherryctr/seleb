...
document.querySelector(".bg").style =
...
function changeBtn(b1, b2) {
	btn.style =
		"transition: .3s ease; opacity: 0; scale: 0; transform: translateY(20px);";
	setTimeout(function () {
		b1.style = "display: none";
		b2.style = "display: flex";
		setTimeout(function () {
			btn.style =
				"transition: .5s ease; opacity: 1; scale: 1; transform: translateY(0px);";
		}, 50);
	}, 500);
}
...
function changeStiker(s1, s2) {
	stiker.style =
		"transition: .3s ease; opacity: 0; scale: 0.3; transform: translateY(-100px)";
	setTimeout(function () {
...
// 	.setAttribute(
// 		"action",
// 		"index.php" + "?link=" + window.location.origin + window.location.pathname
// );
...
function openWhatsApp() {
	var message = document.getElementById("pesanTextarea").value; // Get the message from the textarea
	var phoneNumber = "123456789"; // Replace with the recipient's phone number
